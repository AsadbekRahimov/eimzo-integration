...
@section('content')
    ...
    <div class="card">
        ...
        <a href="{{ route('eimzo.examples.login') }}">Open login example</a>
    </div>
    ...
    <div class="card">
        ...
        <a href="{{ route('eimzo.examples.document-sign') }}">Open document signing example</a>
    </div>
    ...
    <div class="card">
        ...
        <a href="{{ route('eimzo.examples.action-sign') }}">Open action signing example</a>
    </div>
@endsection
